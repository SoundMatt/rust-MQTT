...
- RELAY spec v1.10 full conformance (§20 continuous conformance)
...
|---|---|---|
| **v1.0** | Foundation: Client trait, mock broker, v3.1.1 TCP client, RELAY v1.10 conformance, CI, safety artefacts | ✅ |
